require([
	...
	function(
		Map, MapView, FeatureLayer, GroupLayer, LayerList, Geometry
	) {
		...
		var censusGroupLayer = new GroupLayer({
			...
			layers: [censusPre1950Layer, census1950Layer, census1960Layer, census1970Layer, census1980Layer, census1990Layer]
		});
